...
<?php } else if($filtro == 2){ ?>
			    <ul class="navbar-nav">
			      <li class="nav-item">
			        <a class="nav-link" href="home.php?filter=1">New</a>
			      </li>
			      <li class="nav-item">
			        <a class="nav-link active" href="home.php?filter=2">Best</a>
			      </li>
			      <li class="nav-item">
			        <a class="nav-link" href="home.php?filter=3">Top</a>
			      </li>
...
<?php } else if($filtro == 3){ ?>
			    <ul class="navbar-nav">
			      ...
			      <li class="nav-item">
			        <a class="nav-link active" href="home.php?filter=3">Top</a>
			      </li>
			      <li class="nav-item">
			        <a class="nav-link disabled" href="#">Premium</a>
			      </li>
